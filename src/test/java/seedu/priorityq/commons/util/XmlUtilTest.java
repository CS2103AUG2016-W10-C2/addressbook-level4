package seedu.priorityq.commons.util;
...
import seedu.priorityq.testutil.TaskManagerBuilder;
...
public class XmlUtilTest {
    ...
    public void saveDataToFile_validFile_dataSaved() throws Exception {
        ...
        dataToWrite = new XmlSerializableTaskManager(builder.withEntry(TestUtil.generateSampleEntryData().get(0)).withTag("Friends").build());
